...
function fhFlatPose(n) {
  // Level swing → arm rises through contact to shoulder height, then wraps.
  return {
    hips: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.10, 0.15, 0.30, 0.25, 0.18, 0.12]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.3, -1.1, 0.35, 0.8, 1.2, 0.85]),
      0,
    ],
    shoulderR: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.2, -0.55, -0.35, -0.75, -0.5, 0.1]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0, -1.2, 0.15, 0.6, 1.5, 1.1]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.25, 0.7, 1.45, 1.1, 0.8, 0.5]),
    ],
    elbowR: [kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.6, 1.1, 0.2, 0.3, 0.95, 0.6]), 0, 0],
    racket: [kf(n, [0, 0.25, 0.4, 1], [0.3, 0.9, 0.05, 0.3]), 0, 0],
    kneeBend: kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.3, 0.55, 0.35, 0.25, 0.2, 0.22]),
    baseY: 0.83 - kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.02, 0.09, 0.03, 0.05, 0, 0.01]),
  };
}

function fhTopspinPose(n) {
  // Low→high swing: racket drops below ball, steep rise, windshield-wiper finish high.
  return {
    hips: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.10, 0.12, 0.32, 0.22, 0.16, 0.12]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.3, -1.2, 0.3, 0.7, 1.4, 0.85]),
      0,
    ],
    shoulderR: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.4, -0.65, -0.85, -1.1, -0.7, 0.1]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0, -1.2, 0.1, 0.5, 1.6, 1.1]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.25, 0.5, 1.6, 1.1, 0.6, 0.4]),
    ],
    elbowR: [kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.6, 0.95, 0.15, 0.25, 0.95, 0.55]), 0, 0],
    racket: [kf(n, [0, 0.25, 0.4, 1], [0.3, 0.75, -0.1, 0.2]), 0, 0],
    kneeBend: kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.3, 0.65, 0.40, 0.25, 0.18, 0.22]),
    baseY: 0.83 - kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.01, 0.10, 0.05, 0.06, 0, 0.01]),
  };
}
...
function bhFlatPose(n) {
  return {
    hips: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.10, 0.13, 0.28, 0.24, 0.18, 0.12]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.3, 1.2, -0.3, -0.7, -1.1, -0.7]),
      0,
    ],
    shoulderR: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.2, -0.5, -0.3, -0.7, -0.4, 0.2]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0, 1.3, -0.1, -0.5, -1.2, -0.9]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.25, 0.5, 1.1, 0.9, 0.7, 0.4]),
    ],
    elbowR: [kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.6, 1.0, 0.15, 0.25, 0.9, 0.55]), 0, 0],
    // Left arm (non-dominant) follows the right — double-handed grip
    shoulderL: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.2, -0.45, -0.35, -0.65, -0.4, 0.15]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.2, 1.3, -0.05, -0.55, -1.15, -0.85]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.2, 0.35, 0.75, 0.65, 0.45, 0.15]),
    ],
    elbowL: [kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.6, 0.95, 0.1, 0.2, 0.85, 0.65]), 0, 0],
...
function bhTopspinPose(n) {
  return {
    hips: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.10, 0.12, 0.30, 0.22, 0.15, 0.12]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.3, 1.3, -0.25, -0.6, -1.3, -0.7]),
      0,
    ],
    shoulderR: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.35, -0.6, -0.75, -1.05, -0.65, 0.2]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0, 1.3, -0.05, -0.45, -1.4, -0.9]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.25, 0.45, 1.3, 0.9, 0.5, 0.3]),
    ],
    elbowR: [kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.6, 0.9, 0.1, 0.2, 0.9, 0.5]), 0, 0],
    shoulderL: [
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.35, -0.55, -0.78, -1.0, -0.6, 0.15]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.2, 1.3, -0.02, -0.5, -1.35, -0.85]),
      kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [-0.2, 0.3, 0.9, 0.65, 0.4, 0.1]),
    ],
    elbowL: [kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.6, 0.85, 0.05, 0.15, 0.85, 0.6]), 0, 0],
    racket: [kf(n, [0, 0.25, 0.4, 1], [0.3, 0.7, -0.15, 0.2]), 0, 0],
    kneeBend: kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.3, 0.65, 0.38, 0.25, 0.18, 0.22]),
    baseY: 0.83 - kf(n, [0, 0.25, 0.4, 0.55, 0.8, 1], [0.01, 0.10, 0.04, 0.06, 0, 0.01]),
  };
}
